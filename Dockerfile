...
RUN (wget http://download3.rstudio.org/ubuntu-12.04/x86_64/shiny-server-0.4.0.8-amd64.deb && gdebi --n shiny-server-0.4.0.8-amd64.deb)
RUN (rm shiny-server-0.4.0.8-amd64.deb && mkdir -p /srv/shiny-server)
